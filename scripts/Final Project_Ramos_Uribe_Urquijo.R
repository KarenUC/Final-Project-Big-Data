...
rownames(var_imp_logitlasso) = c("No.Conductores Moto", "No. Conductores Bici", "No. Conductores de Autos", "No. Mujeres Victimas",
                          "Tipo de Accidente = Choque", "No. V韈timas en Auto", "No. Hombres Victimas", "No. Peatones V韈timas",
                          "V韈tima Joven", "No. Motos V韈timas", "No. Conductores Veh韈ulo Carga", "No. Conductores Serv. P鷅lico",
                          "No. V韈timas Serv. P鷅lico", "Ca韉a Ocupante", "Otra Infracci髇", "V韈tima Mayor", "V韈tima Anciano", 
                          "V韈tima Menor de Edad", "Madrugada", "Sin Velocidad")
...
rownames(var_imp_xgb) = c("No.Conductores Moto", "Tipo Accidente = Choque", "No.Conductores Bici", 
                              "No. Peatones V韈timas", "No. Conductores Autos", "Victima Joven", "No. Mujeres Victimas",
                              "No. Hombres Victimas", "No. Motos Victimas", "No. Autos Victimas", "No. Conductores Servicio Pub",
                              "No.Conductores Veh韈ulo Carga", "No. Hombres Conductores", "Intersecci髇", "Madrugada", "Conductor Joven", "Tramo V韆",
                              "No. Mujeres Conductores", "Otra Infracci髇", "Viernes")
